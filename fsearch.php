...
require_once __DIR__ . '/frecipe.php';

// Initialize the controller
$recipeController = new RecipeController2();
...
$dietaryOptions = ['Vegetarian', 'Vegan', 'Keto', "Gluten-free","Dairy-free"];
...
<div class="container mx-auto p-4">
    ...
    <div class="relative mb-6">
        ...
        <form action="" method="GET" id="search-form">
            ...
            <!--					  --><?php //if ($priceRange): ?>
            <!--					  <input type="hidden" name="price_range" value="--><?php //= htmlspecialchars($priceRange) ?><!--">-->
            <!--					  --><?php //endif; ?>
        </form>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-1/3 h-fit bg-white rounded-lg shadow p-6">
            ...
            <form action="" method="GET" class="space-y-6" id="filter-form">
                        ...
                        <?php foreach ($dietaryOptions as $option): ?>
                            <div class="flex items-center">
                                <input type="radio" name="dietary" value="<?= htmlspecialchars($option) ?>"
                                    ...
                                    <?= isset($dietary) && $dietary === $option ? 'checked' : '' ?>>
                ...
                <!--                                <option value="">Any</option>-->
                <!--                                <option value="budget" --><?php //= $priceRange === 'budget' ? 'selected' : '' ?><!--//>Budget (< $5)</option>-->
                <!--                                <option value="moderate" --><?php //= $priceRange === 'moderate' ? 'selected' : '' ?><!--//>Moderate ($5-$10)</option>-->
                <!--                                <option value="premium" --><?php //= $priceRange === 'premium' ? 'selected' : '' ?><!--//>Premium (> $10)</option>-->
                <!--                            </select>-->
                <!--                        </div>-->
                <!--                    </div>-->
