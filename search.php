...
// [Get the passed-in date (default to Monday if not provided)
$currentDay = $_GET['day'] ?? 'Monday';
            ...
            <div id="results" class="w-full md:w-2/3">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <?php else: ?>
                       ...
                       <!-- Modify the link to include the day parameter -->
                       <a href="recipe.php?day=<?= urlencode($currentDay) ?>&id=<?= htmlspecialchars($recipe['id']) ?>&from=header" class="block bg-white rounded-lg shadow overflow-hidden hover:shadow-md transition-shadow duration-200">
