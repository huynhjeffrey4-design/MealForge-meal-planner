...
<head>
    ...
    <title>Log in to your MealForge account</title>
    ...
    <style>
        ...
        .login-illustration {
            background-image: url('uploads/mealforge_login.png');
...
<body class="bg-white min-h-screen">
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="bg-primary w-full md:w-1/2 p-6 md:p-10 lg:p-20 login-illustration">
            <div class="max-w-2xl mx-auto">
                <h1 class="text-2xl font-bold mb-6 md:mb-10 text-white">MealForge</h1>
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-white">Log in to your<br>MealForge account</h2>
